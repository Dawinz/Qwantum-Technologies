        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex-shrink-0">
            <Link to="/" className="flex items-center">
              ...
              />
              <img 
                src="/images/logo-navbar-mobile.png" 
                alt="Zuberi Express" 
                className="h-6 w-auto md:hidden"
                style={{ display: 'none' }}
              />
              <span className="text-xl font-bebas font-bold tracking-wider hover:text-zuberi-lime transition-colors duration-200 ml-2">
                ZUBERI EXPRESS
              </span>
            </Link>
          </div>
